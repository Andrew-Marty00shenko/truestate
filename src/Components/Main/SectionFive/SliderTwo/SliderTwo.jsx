...
const SliderTwo = ({ setShowFirstSlider, setShowSecondSlider, ...object }) => {
    const [openInfoEstate, setOpenInfoEstate] = useState(false);
    const [modalShow, setModalShow] = useState(false);
    const [activeBigImage, setActiveBigImage] = useState(object.bigImage);

...
const Documents = () => {
    ...
    const handleUploadPassport = (e) => {
        setPassportValue(e.target.files[0])
    };
    ...
    const handleUploadAddress = (e) => {
        setAddressValue(e.target.files[0])
    };
            ...
            <div className="documents__block">
                <div className="documents__block-file">
                    <label htmlFor="passport">
                        ...
                        <span>
                            {passportValue === '' ? 'Паспорт' : passportValue.name}
                        </span>
                    </label>
                </div>
                <div>
                    <Form.Select className="documents__block-select">
                        <option value="" disabled selected>Выбери страну</option>
                    </Form.Select>
                </div>
            </div>
            <div className="documents__block">
            ...
            <div className="documents__block">
                <div className="documents__block-file">
                    <label htmlFor="id">
                        ...
                        <span>
                            {addressValue === '' ? 'Proof of address' : addressValue.name}
                        </span>
                    </label>
                </div>
                <div>
                    <Form.Select className="documents__block-select">
                        <option value="" disabled selected>Банковская выписка</option>
                    </Form.Select>
                </div>
            </div>
            <Button>

...
const Documents = () => {
    ...
    const [idValueSecond, setIdValueSecond] = useState('');
    ...
    useEffect(() => {
        if (allFields) {
            ...
            setIdValueSecond(allFields.id_2);
        }
    }, [allFields]);
        ...
        <div className="documents-width">
            <div className="documents__block">
                            ...
                            <>
                                <label htmlFor="passport">
                                    ...
                                    <OverlayTrigger placement="top"
                                        overlay={
                                            <Tooltip>
                                                {t('documents:INFO_PASSPORT')}
                                            </Tooltip>
                                        }
                                    >
                                        <svg style={{ left: 5, top: 5 }} width="15" version="1.1" id="Capa_1" x="0px" y="0px"
                                            viewBox="0 0 302.967 302.967">
                                            <path fill="#8d8d8d" d="M151.483,302.967C67.956,302.967,0,235.017,0,151.483S67.956,0,151.483,0
				...
				s57.001,127.067,127.067,127.067s127.067-57.001,127.067-127.067S221.555,24.416,151.483,24.416z"/>
                                            <path fill="#8d8d8d" d="M116.586,118.12c1.795-4.607,4.297-8.588,7.511-11.961c3.225-3.389,7.114-6.016,11.667-7.898
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    <OverlayTrigger placement="top"
                        overlay={
                            <Tooltip>
                                {t('documents:INFO_COUNTRY_PASSPORT')}
                            </Tooltip>
                        }
                    >
                        <svg style={{ left: 6, top: 13, position: 'absolute', cursor: 'pointer' }} width="15" version="1.1" id="Capa_1" x="0px" y="0px"
                            viewBox="0 0 302.967 302.967">
                            <path fill="#8d8d8d" d="M151.483,302.967C67.956,302.967,0,235.017,0,151.483S67.956,0,151.483,0
				s151.483,67.956,151.483,151.483S235.017,302.967,151.483,302.967z M151.483,24.416c-70.066,0-127.067,57.001-127.067,127.067
				s57.001,127.067,127.067,127.067s127.067-57.001,127.067-127.067S221.555,24.416,151.483,24.416z"/>
            ...
            <div className="documents__block">
				...
				s57.001,127.067,127.067,127.067s127.067-57.001,127.067-127.067S221.555,24.416,151.483,24.416z"/>
					...
					C113.85,127.785,114.791,122.732,116.586,118.12z M162.536,183.938v23.616h-24.09v-23.616H162.536z"/>
                            ...
                            <div>
                                <img
                                    src={`${url}${kycData.idFiles[1]}`}
                                    onClick={() => {
                                        setModalShow(true);
                                        setActiveBigImage(kycData.idFiles[1])
                                    }}
                                    alt=""
                                    style={{ cursor: 'pointer', borderRadius: 6, }}
                                />
				...
				s57.001,127.067,127.067,127.067s127.067-57.001,127.067-127.067S221.555,24.416,151.483,24.416z"/>
                    ...
                    {errors?.countryId && <p style={{ color: "#ff0000", marginTop: 5 }}>
                        {t('dataInput:INPUT_ERROR')}
                    </p>}
                </div>
            </div>
            <div className="documents__block">
                            ...
                            <>
                                <label htmlFor="address">
                                    ...
                                    <OverlayTrigger placement="top"
                                        overlay={
                                            <Tooltip>
                                                {t('documents:INFO_CONFIRMATION_ADDRESS')}
                                            </Tooltip>
                                        }
                                    >
                                        <svg style={{ left: 5, top: 5 }} width="15" version="1.1" id="Capa_1" x="0px" y="0px"
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    <OverlayTrigger placement="top"
                        overlay={
                            <Tooltip>
                                {t('documents:INFO_COUNTRY_CONFIRMATION')}
                            </Tooltip>
                        }
                    >
                        <svg style={{ left: 6, top: 13, position: 'absolute', cursor: 'pointer' }} width="15" version="1.1" id="Capa_1" x="0px" y="0px"
            ...
            <Button
                type="submit"
                disabled={kycData?.status === 2 || loading || !isDirty}
            >
                {t('documents:SEND')}
